...
def memory_region():
    match segment:
        ...
        # case "stack":
        #     return stackStartIndex[0][0], stackEndIndex[0][0]
        case "heap":
            return stackEndIndex[0][0], end
        case "stack":
            return stackEndIndex[0][0], end      
        case "all":
...
ax2.semilogy(bits[leftindex32:rightindex32], flips[leftindex32:rightindex32], 'g*', label='FlipsAEW')
...
ax3.semilogy(bits[leftindex16:rightindex16], flips[leftindex16:rightindex16], 'g*', label='FlipsAEW')
